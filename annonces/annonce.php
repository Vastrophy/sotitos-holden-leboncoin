...
$result = mysqli_query($con, "SELECT * FROM `annonce` WHERE `ID` = '$idUser'") or die(mysqli_error($con));
while ($getInfo = mysqli_fetch_array($result)) {
    $ID_CLIENT = $getInfo['ID_CLIENT'];
	$TITRE = $getInfo['TITRE'];
	$URL = $getInfo['URL'];
	$VENTEPRIX = $getInfo['VENTEPRIX'];
	$OBJET = $getInfo['OBJET'];
	$DESCRIPTION = $getInfo['DESCRIPTION'];
	$TEL = $getInfo['TEL'];
	$DISCORDMAIL = $getInfo['DISCORDMAIL'];
