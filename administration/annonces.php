  ...
  <section id="services" class="section-bg">
    <div class="container">
      <header class="section-header">
        ...
        <p>Liste de toute les Annonces LeBonCoin de Grand Paris RP</p>
      </header>
      <div class="row">
...
<tr role="row" class="odd">
										...
										$prix = $resultatInfos['VENTEPRIX'];

                                        
                                        ?>
                                        </td>
                                        <td class="text-center"><b><font color=white><?php echo $titre; ?></font></b></td>
										<td class="text-center"><b><font color=white><?php echo $prix; ?></font></b></td>
										<td class="text-center"><b><font color=white><?php echo $VENDEUR; ?></font></b></td>
										<td class="text-center"><b><font color=white><?php echo date("d-m-Y à H:i:s", $resultatInfos['DATE']); ?></font></b></td>
                                        <td class="text-center"><a class="btn btn-success" href="annonce-edit.php?id=<?php echo $resultatInfos['ID']; ?>">Edit</a>
                                        </td>
                                    </tr>
									 <?php } ?>
  </tbody>
